          ...
          if ($the_query->have_posts()) :
            while ($the_query->have_posts()) :
              ...
              <div class="swiper-slide">
                <img class="swiper-img" src="<?php attachment_image('full', 'url'); ?>" srcset="<?php attachment_image('large', 'url'); ?> 1000w, <?php attachment_image('full', 'url'); ?> 1920w," alt="" width="1920" height="1440" decoding="async">
