  ...
  <ol>
    <?php
      while (have_posts()) :
        ...
        ?>
        <li>
          <a href="<?php the_permalink(); ?>" rel="bookmark norewrite" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a>
          <!-- (<?php the_score(); ?>)--></li>
      <?php endwhile; ?>
  </ol>
...
<?php
  ...
  the_post();
?>
<p>No related posts were found, so here's a consolation prize:
  <a href="<?php the_permalink(); ?>" rel="bookmark norewrite" title="<?php the_title_attribute(); ?>><?php the_title(); ?></a>.</p>
<?php endif; ?>
