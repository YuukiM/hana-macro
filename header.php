        ...
        <?php if (have_posts()) : ?>
          <?php while (have_posts()) : the_post(); ?>
            ...
            <meta property="og:title" content="<?php single_tag_title();
              echo 'の花の一覧' ?> | <?php bloginfo('name'); ?>"/>
            <meta property="og:description" content="<?php single_tag_title();
              echo "の花のマクロ写真を無料ダウンロード" ?>"/>
            <meta property="og:site_name" content="<?php bloginfo('name'); ?>"/>
            <meta property="og:image" content="<?php attachment_image('full', 'url'); ?>"/>
          <?php endwhile; ?>
        <?php endif; ?>
        ...
        <?php if (have_posts()) : ?>
          <?php while (have_posts()) : the_post(); ?>
            ...
            <meta property="og:title" content="<?php single_cat_title();
              echo 'に咲く花の一覧' ?> | <?php bloginfo('name'); ?>"/>
            <meta property="og:description" content="<?php single_cat_title();
              echo "に咲く花のマクロ写真を無料ダウンロード" ?>"/>
            <meta property="og:site_name" content="<?php bloginfo('name'); ?>"/>
            <meta property="og:image" content="<?php attachment_image('full', 'url'); ?>"/>
          <?php endwhile; ?>
        <?php endif; ?>
...
<header class="header js-header">
  ...
  <ul class="header__nav">
    <li>
      <a class="header__nav-link" href="<?php echo esc_url(home_url('/')); ?>" title="ホーム">
    ...
    <li>
      <a class="header__nav-link" href="<?php echo esc_url(home_url('/seasons/')); ?>" title="四季の花一覧">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    <li>
      <a href="#tagModal" class="header__nav-link tag-modal" title="タグ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    <?php if (is_home()): ?>
      <li>
        <a href="#" class="header__nav-link js-home-search" title="検索">
          <label for="s">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    <?php else: ?>
      <li>
        <a href="#searchModal" class="header__nav-link search-modal" title="検索">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            <path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/>
          </svg>
          <p>検索</p>
